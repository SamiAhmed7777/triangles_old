...
{
    BOOST_CHECK(TestSplitHost("info.triangles.technology", "info.triangles.technology", -1));
    BOOST_CHECK(TestSplitHost("[info.triangles.technology]", "info.triangles.technology", -1));
    BOOST_CHECK(TestSplitHost("info.triangles.technology:80", "info.triangles.technology", 80));
    BOOST_CHECK(TestSplitHost("[info.triangles.technology]:80", "info.triangles.technology", 80));
